...
function upgradeDraw() {
  ...
  drawing.printAtWordWrap(
    context,
    player.getCurrentMoney().toString(),
    370,
    115,
    10,
    100,
...
function riceCookerUpgradesSetup(x, y) {
  //0 200
  upgradeButtons.push(
    new shapes.UpgradeButton(
      shapes.shapeType.ROUNDRECT,
      x + 140,
      y + 25,
      58,
      50,
      10,
      riceCooker.getCookTimeUpgradeCost(),
      "Black",
      "25px Arial",
      "Gray",
      "Green",
      "Red",
      riceCooker.riceCookerUpgradeCookTime,
      riceCooker.getCookTimeUpgradeCost,
      "Rice Cooker Upgrade Cook Time"
    )
  );
  upgradeButtons.push(
    new shapes.UpgradeButton(
      ...
      50,
      10,
      riceCooker.getRiceCountUpgradeCost(),
      "Black",
      "25px Arial",
      "Gray",
      "Green",
      "Red",
      riceCooker.riceCookerUpgradeRiceCount,
      riceCooker.getRiceCountUpgradeCost,
      "Rice Cooker Upgrade Rice Count"
    )
  );
}
function storageBoxUpgradesSetup(x, y) {
  //0 10
  upgradeButtons.push(
    new shapes.UpgradeButton(
      shapes.shapeType.ROUNDRECT,
      ...
      50,
      10,
      storage.getIngredientBox1UpgradeCost(),
      "Black",
      "25px Arial",
      "Gray",
      "Green",
      "Red",
      storage.upgradeIngredientBox1Storage,
      storage.getIngredientBox1UpgradeCost,
      "Storage Box Upgrade Max Storage 1"
    )
  );
  upgradeButtons.push(
    new shapes.UpgradeButton(
      ...
      50,
      10,
      storage.getIngredientBox2UpgradeCost(),
      "Black",
      "25px Arial",
      "Gray",
      "Green",
      "Red",
      storage.upgradeIngredientBox2Storage,
      storage.getIngredientBox2UpgradeCost,
      "Storage Box Upgrade Max Storage 2"
    )
  );
}

function rollingMattUpgradesSetup(x, y) {
  //400 10
  upgradeButtons.push(
    new shapes.UpgradeButton(
      shapes.shapeType.ROUNDRECT,
      ...
      50,
      10,
      rollingMatt.getSpeedUpgradeCost(),
      "Black",
      "25px Arial",
      "Gray",
      "Green",
      "Red",
      rollingMatt.upgradeSpeed,
      rollingMatt.getSpeedUpgradeCost,
      "RollingMatt Upgrade Speed"
    )
  );
}
function cuttingBoardUpgradesSetup(x, y) {
  //201 200
  ...
  upgradeButtons.push(
    new shapes.UpgradeButton(
      ...
      50,
      10,
      cuttingStation.getCuttingSpeedCost(),
      "Black",
      "25px Arial",
      "Gray",
      "Green",
      "Red",
      cuttingStation.upgradeCuttingSpeed,
      cuttingStation.getCuttingSpeedCost,
      "Cutting Board Upgrade Speed"
    )
  );
  if (data.useSecondBoard == false) {
    upgradeButtons.push(
      new shapes.UpgradeButton(
        ...
        50,
        10,
        cuttingStation.getSecondBoardCost(),
        "Black",
        "25px Arial",
        "Gray",
        "Green",
        "Red",
        cuttingStation.buyNewCuttingBoard,
        cuttingStation.getSecondBoardCost,
        "Cuttin Board Upgrade Second Board"
      )
    );
  }
}
function teaKettleUpgradesSetup(x, y) {
  //401 200
  ...
  upgradeButtons.push(
    new shapes.UpgradeButton(
      ...
      50,
      10,
      teaKettle.getSteepTimeUpgradeCost(),
      "Black",
      "25px Arial",
      "Gray",
      "Green",
      "Red",
      teaKettle.upgradeSteepTime,
      teaKettle.getSteepTimeUpgradeCost,
      "Tea kettle Upgrade Speed"
    )
  );
  ...
  upgradeButtons.push(
    new shapes.UpgradeButton(
      ...
      50,
      10,
      teaKettle.getStorageUpgradeCost(),
      "Black",
      "25px Arial",
      "Gray",
      "Green",
      "Red",
      teaKettle.upgradeStorageCount,
      teaKettle.getStorageUpgradeCost,
      "Tea kettle Upgrade Storage"
    )
  );
}

function riceCookerUpgradesDraw(x, y) {
  //200
...
function storageBoxUpgradesDraw(x, y) {
  //0 10
...
function rollingMattUpgradesDraw(x, y) {
  //400 10
...
function cuttingBoardUpgradesDraw(x, y) {
  //201 200
  var data = cuttingStation.getData();
  drawing.drawRoundRect(
    context,
...
function teaKettleUpgradesDraw(x, y) {
  //401 200
  drawing.drawRoundRect(
    context,
    x,
...
function drawSpeedUpgrade(x, y, callback, name, cost) {
  ioControl.addButton(
    shapes.createButton(x, y, 100, 50, cost.toString(), true, 1, callback, name)
  );
}
