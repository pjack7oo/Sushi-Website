...
export class CuttingStation{
  ...
  checkCutRoll() {
    if (this.isActive == true) {
      let currentTime = performance.now(),
        ...
        percentComplete =
          (elapsedTime / (this.cuttingSpeed * 1000)) * 100;
  ...
  checkCuttingStation(mySelect) {
    if (mySelect != null) {
      ...
      if (
        shapes.Contains(this, mySelect.renderType) &&
        this.item == null
      ) {
        this.item = mySelect;
...
var cuttingStation = CuttingStation, cuttingStation2 = cuttingStation;
...
//   progress: 0
// };
var bar = progBar.progressbar, bar2 = progBar.progressbar;
