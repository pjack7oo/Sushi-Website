...
export function startLevel() {
    ...
    if (currentLevel == 0) {
        ...
        timedBox.createTimedBox(110,100,150,100,"<-- 2)Ohh! look theres a customer.",10,'left',true,true, "white", "red");
        
        timedBox.createTimedBox(300,100,200,150,"3)Hes gonna want a California roll,cucumber, crab, and avocado.",25,'center',true,true,'white', 'red', 25);
