...
function findIngredient(ingredient) {
  ...
  return (
    mypick.name === ingredient.name &&
    mypick.renderType.x == ingredient.renderType.x &&
    mypick.renderType.y == ingredient.renderType.y
  );
}
