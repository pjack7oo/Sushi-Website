...
class IngredientBox {
  ...
  contains(type) {
    return (
      this.typeStorage1name == type ||
      this.typeStorage2name == type ||
      this.typeStorage3name == type
    );
  }
  ...
  fillIngredient(type) {
    if (this.typeStorage1name == type) {
      ...
      for (let i = 0; i < max; i++) {
        ...
        let ingredient = ingredients.createIngredientWithXY(
          this.typeStorage1name,
          x,
          y
        );
        ingredient.id = i;
...
var ingredientBox1 = IngredientBox,
  ingredientBox2 = IngredientBox;
...
export function getData() {
  ...
  ingredientBoxData.ingredientBox1.maxStorageUpgradeCost =
    ingredientBox1.maxStorageUpgradeCost;
  ingredientBoxData.ingredientBox2.maxStorage = ingredientBox2.maxStorage;
  ingredientBoxData.ingredientBox2.maxStorageUpgradeCost =
    ingredientBox2.maxStorageUpgradeCost;
...
export function setData(data) {
  ...
  ingredientBox1.maxStorageUpgradeCost =
    data.ingredientBox1.maxStorageUpgradeCost;
  ingredientBox2.maxStorage = data.ingredientBox2.maxStorage;
  ingredientBox2.maxStorageUpgradeCost =
    data.ingredientBox2.maxStorageUpgradeCost;
}

export function initIngredientBoxes() {
  ingredientBox1 = new IngredientBox(
    30,
    280,
    200,
    110,
    mainIngredientTypes.FISH,
    "#B87C4B",
    "#966047"
  );
  ingredientBox2 = new IngredientBox(
    30,
    390,
    200,
    110,
    mainIngredientTypes.VEGETABLES,
    "#B87C4B",
    "#966047"
  );
...
export function removeIngredient(ingredient) {
  ...
  if (ingredientBox1.contains(ingredient.name)) {
    if (ingredientBox1.typeStorage1name == ingredient.name) {
      ...
      ingredientBox1.typeStorage1Missing.push(
        ingredientBox1.typeStorage1[missing].id
      );
    ...
    if (ingredientBox1.typeStorage2name == ingredient.name) {
      ...
      ingredientBox1.typeStorage2Missing.push(
        ingredientBox1.typeStorage2[missing].id
      );
    ...
    if (ingredientBox1.typeStorage3name == ingredient.name) {
      ...
      ingredientBox1.typeStorage3Missing.push(
        ingredientBox1.typeStorage3[missing].id
      );
  ...
  if (ingredientBox2.contains(ingredient.name)) {
    if (ingredientBox2.typeStorage1name == ingredient.name) {
      ...
      ingredientBox2.typeStorage1Missing.push(
        ingredientBox2.typeStorage1[missing].id
      );
    ...
    if (ingredientBox2.typeStorage2name == ingredient.name) {
      ...
      ingredientBox2.typeStorage2Missing.push(
        ingredientBox2.typeStorage2[missing].id
      );
    ...
    if (ingredientBox2.typeStorage3name == ingredient.name) {
      ...
      ingredientBox2.typeStorage3Missing.push(
        ingredientBox2.typeStorage3[missing].id
      );
...
function findIngredient(ingredient) {
  ...
  return (
    ingredientToRemove.name == ingredient.name &&
    ingredientToRemove.renderType.x == ingredient.renderType.x &&
    ingredientToRemove.renderType.y == ingredient.renderType.y
  );
}
