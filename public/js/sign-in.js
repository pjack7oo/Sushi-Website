  ...
  $("#login-submit").click(function () {
    ...
    $.ajax({
        ...
        if (resp.success == true) {
          ...
          switch (resp.extras.msg) {
            case SushiCat.ApiMessages.DB_ERROR:
              $ctnErr.html(
                "<p> Oops! SushiCat had a problem and can't login right now. Try again in a bit."
              );
            ...
            case SushiCat.ApiMessages.USERNAME_NOT_FOUND:
              $ctnErr.html(
                "<p>You entered a wrong username or password.  Please try again.</p>"
              );
              $ctnErr.addClass("bi-ctn-err").slideDown();
      ...
      error: function (e) {
        ...
        $ctnErr.html(
          "<p> SushiCat had a problem and can't login right now. Try again in a bit."
        );
        $ctnErr.addClass("bi-ctn-err").slideDown();
      },
    });
