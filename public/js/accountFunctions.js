...
$(document).ready(function () {
    $('#resetPassword-submit').click(function() {
        ...
        $.ajax({
            ...
            data: "username=" + username+"&newPassword=" + newPassword + "&newPasswordConfirm=" + newPasswordConfrim,
                ...
                if ( resp.success == true) {
                    ...
                    switch (resp.extras.msg) {
                        case SushiCat.ApiMessages.PASSWORD_CONFIRM_MISMATCH:
                            $ctnErr.html("<p>You passwords didn't match.  Please try again.</p>");
                            $ctnErr.addClass("bi-ctn-err").slideDown();
            ...
            error: function(error) {
                ...
                $ctnErr.html("<p>Oops! SushiCat had a problem and could not reset your password.  Please try again in a few minutes.</p>");
                $ctnErr.addClass("bi-ctn-err").slideDown();
            }
        })
    });
...
function clearSave() {
    ...
    $.ajax({
        ...
        error: function(error) {
            console.log(e.message);
                $ctnErr.html("<p>Oops! SushiCat had a problem and could not clear your save.  Please try again in a few minutes.</p>");
                $ctnErr.addClass("bi-ctn-err").slideDown();
        }
    });
}