...
var BostonRoll = new RollSchema({
    ...
    outer: ["Rice"],
    nori : true,
    description: "Standard roll follow basic instructions. Optionally top with sesame seeds or roe.",
...
var DragonRoll = new RollSchema({
    ...
    outer: ["Avocado", "Rice"],
    nori : true,
    description: "Standard roll follow basic instructions except to layer the Avocado on the outside after rolling.",
...
var EelAvocadoRoll = new RollSchema({
    ...
    nori : true,
    description: "Standard roll follow basic instructions except to layer the Avocado on the outside after rolling.",
    image: {data: fs.readFileSync(eelAvocadoRollImage), contentType: "image/png"}
});
var MangoRoll = new RollSchema({
    ...
    nori : true,
    description: "Layer the Mango slices on the outside after rolling. You can use creamy mango paste to help the mango stick.",
...
var SpiceTatakiRoll = new RollSchema({
    ...
    image: {data: fs.readFileSync(spicyTatakiRollImage), contentType: "image/png"}
});
